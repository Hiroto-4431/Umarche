                            ...
                            <div class="-m-2">
                                ...
                                <div class="p-2 w-1/2 mx-auto">
                                    <div class="relative">
                                        ...
                                        <textarea id="information" name="information" rows="10"
                                            class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                                            required>{{ $shop->information }}</textarea>
                                    </div>
                                </div>
                                <div class="p-2 w-1/2 mx-auto">
                                    <div class="relative">
                                ...
                                <div class="p-2 w-1/2 mx-auto">
                                    <div class="relative flex justify-around">
                                        <div>
                                            <input type="radio" id="is_selling" name="is_selling" value="1" @if($shop->is_selling === 1){ checked }@endif class="mr-2">販売中
                                        </div>
                                        <div>
                                            <input type="radio" id="is_selling" name="is_selling" value="0" @if($shop->is_selling === 0){ checked }@endif class="mr-2">停止中
                                        </div>
